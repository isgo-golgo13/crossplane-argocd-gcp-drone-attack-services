...
```shell
helm template crossplane-gcp-control-plane-provider-config ./crossplane-gcp-control-plane-provider-config \
  --namespace crossplane-system 
```
...
```shell
helm install crossplane-gcp-control-plane-provider-config ./crossplane-gcp-control-plane-provider-config \
  --namespace crossplane-system 
```
